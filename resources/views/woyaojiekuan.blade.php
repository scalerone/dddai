...
<style class="css/firebugResetStyles" type="text/css" charset="utf-8">/* See license.txt for terms of usage */
/** reset styling **/
.firebugResetStyles {
...
<div class="clearfix foot2 wb_1000">
	<div class="out ff">
        <div class="line1">
			...
			<a href="#" target="_blank">栏目列表</a>
			<a href="#" target="_blank">文章列表1</a>
			<a href="#" target="_blank">文章列表2</a>
			<a href="#" target="_blank">文章列表3</a>
			<a href="#" target="_blank">文章列表4-1</a>
			<a href="#" target="_blank">文章列表4</a>
			<a href="#" target="_blank">文章列表5</a>
			<a href="#" target="_blank">文章列表6</a>
			<a href="#" target="_blank">文章列表7</a>
			<a href="#" target="_blank">文章列表8</a>
			<a href="#" target="_blank">文章列表9</a>
			<a href="#" target="_blank">文章列表10</a>
			<a href="#" target="_blank">文章列表11</a>
			<a href="#" target="_blank">文章列表12</a>
			<a href="#" target="_blank">文章列表13</a>
			<a href="#" target="_blank">文章列表14</a>
			<a href="#" target="_blank">文章列表15</a>
			<a href="#" target="_blank">文章列表16</a>
			<a href="#" target="_blank">文章列表35</a>
			<a href="#" target="_blank">文章列表36</a>
			<a href="#" target="_blank">文章列表37</a>
			<a href="#" target="_blank">文章列表38</a>
			<a href="#" target="_blank">文章列表39</a>
			<a href="#" target="_blank">文章列表40</a>
			<a href="#" target="_blank">文章列表41</a>
			<a href="#" target="_blank">文章列表42</a>
			<a href="#" target="_blank">文章列表43</a>
			<a href="#" target="_blank">文章列表44</a>
			<a href="#" target="_blank">文章列表45</a>
			<a href="#" target="_blank">文章列表46</a>
			<a href="#" target="_blank">文章列表47</a>
			<a href="#" target="_blank">文章列表48</a>
			<a href="#" target="_blank">文章列表49</a>
			<a href="#" target="_blank">文章列表50</a>
			<a href="#" target="_blank">文章列表51</a>
			<a href="#" target="_blank">文章列表52</a>
			<a href="#" target="_blank">文章列表53</a>
			<a href="#" target="_blank">文章列表54</a>
			<a href="#" target="_blank">文章列表55</a>
			<a href="#" target="_blank">文章列表56</a>
			<a href="#" target="_blank">文章列表57</a>
			<a href="#" target="_blank">文章列表58</a>
			<a href="#" target="_blank">文章列表59</a>
			<a href="#" target="_blank">文章列表60</a>
			<a href="#" target="_blank">文章列表61</a>
            </div>
        </div>
        <div class="line2">
