                ...
                <div class="fl l">
                	<h3 class="pl_20 t_bt"><img src="/image/safe_safe_002.png"><span class="fc_green pl_10">账户资金安全由银行委托管理</span></h3>
	                      <ul class="clearfix td_all">
	                    	<li class="fl ">
                                <h4 class="fc_9 pl_20">订单号：263874462143</h4>
                                <p class="pl_20 fs_18 fc_6">
                                您将对宝力矿解毒项目投资500000元，是否确认继续付款以完成操作？
                                 </p>
                            </li>
                	...
                	<div class="td_all2">
                        <table width="100%" class="fc_6">
                            ...
                            <tr>
                                ...
                                <td style="padding-right:0;width:220px;">500000元</td>

                            </tr>                          
                        </tbody>
                        </table>
                        <div class="fc_6 t_r b1 newstyle" style="padding-top:100px;">
                        <form method=post action="http://192.168.1.146/pay/index.php">
                                <input type=hidden name=v_mid value="1009002">
                                <input type=hidden name=v_oid value="20160513-1009002-263874462143">
                                <input type=hidden name=v_amount value="500000">  
                                <input type=hidden name=v_moneytype value="CNY"> 
                                <input type=hidden name=v_url value="http://192.168.1.140/pay_verify">
                                <input type=hidden name=v_md5info value="0952198673061D93B194D7311FFC0717"> 
