...
<div class="index_main w1180 front">
    <div class="login_front">
        ...
        <p class="fs_24 bold m">注册送10000元体验金</p>
         <span id="static_banner_login"><a title="免费注册" rel="nofollow" href="#" class="btn_orange">免费注册</a><a title="马上登录" rel="nofollow" class="orange" href="/login.html">马上登录</a></span>
    </div>
</div>
...
<a target="_blank" href="#">Z</a>|丨
            ...
            <a target="_blank" href="#">X</a>
            <a target="_blank" href="#">Y</a>
            <a target="_blank" href="#">Z</a>
            <a target="_blank" href="#">栏目列表</a>
            <a target="_blank" href="#">文章列表1</a>
            <a target="_blank" href="#">文章列表2</a>
            <a target="_blank" href="#">文章列表3</a>
            <a target="_blank" href="#">文章列表4-1</a>
            <a target="_blank" href="#">文章列表4</a>
            <a target="_blank" href="#">文章列表5</a>
            <a target="_blank" href="#">文章列表6</a>
            <a target="_blank" href="#">文章列表7</a>
            <a target="_blank" href="#">文章列表8</a>
            <a target="_blank" href="#">文章列表9</a>
            <a target="_blank" href="#">文章列表10</a>
            <a target="_blank" href="#">文章列表11</a>
            <a target="_blank" href="#">文章列表12</a>
            <a target="_blank" href="#">文章列表13</a>
            <a target="_blank" href="#">文章列表14</a>
            <a target="_blank" href="#">文章列表15</a>
            <a target="_blank" href="#">文章列表16</a>
            <a target="_blank" href="#">文章列表35</a>
            <a target="_blank" href="#">文章列表36</a>
            <a target="_blank" href="#">文章列表37</a>
            <a target="_blank" href="#">文章列表38</a>
            <a target="_blank" href="#">文章列表39</a>
            <a target="_blank" href="#">文章列表40</a>
            <a target="_blank" href="#">文章列表41</a>
            <a target="_blank" href="#">文章列表42</a>
            <a target="_blank" href="#">文章列表43</a>
            <a target="_blank" href="#">文章列表44</a>
            <a target="_blank" href="#">文章列表45</a>
            <a target="_blank" href="#">文章列表46</a>
            <a target="_blank" href="#">文章列表47</a>
            <a target="_blank" href="#">文章列表48</a>
            <a target="_blank" href="#">文章列表49</a>
            <a target="_blank" href="#">文章列表50</a>
            <a target="_blank" href="#">文章列表51</a>
            <a target="_blank" href="#">文章列表52</a>
            <a target="_blank" href="#">文章列表53</a>
            <a target="_blank" href="#">文章列表54</a>
            <a target="_blank" href="#">文章列表55</a>
            <a target="_blank" href="#">文章列表56</a>
            <a target="_blank" href="#">文章列表57</a>
            <a target="_blank" href="#">文章列表58</a>
            <a target="_blank" href="#">文章列表59</a>
            <a target="_blank" href="#">文章列表60</a>
            <a target="_blank" href="#">文章列表61</a>
            </div>
        </div>
        <div class="line2">
